...
//@interface BayaPOSObject : NSObject
//@end

@interface BayaPOSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BayaPOSObject class]])
		{
			for (NSString *key in [[(BayaPOSObject*)o modules] allKeys])
			{
