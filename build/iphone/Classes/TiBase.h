...
// in simulator we redefine to format for BayaPOS Developer console
...
{\
	NSString * exceptionName = [@"org.bayapos." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bayapos";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBayaPOSNativeItemNone = -1, 
	UIBayaPOSNativeItemSpinner = -2,
	UIBayaPOSNativeItemProgressBar = -3,
	
	UIBayaPOSNativeItemSlider = -4,
	UIBayaPOSNativeItemSwitch = -5,
	UIBayaPOSNativeItemMultiButton = -6,
	UIBayaPOSNativeItemSegmented = -7,
	
	UIBayaPOSNativeItemTextView = -8,
	UIBayaPOSNativeItemTextField = -9,
	UIBayaPOSNativeItemSearchBar = -10,
	
	UIBayaPOSNativeItemPicker = -11,
	UIBayaPOSNativeItemDatePicker = -12,
	
	UIBayaPOSNativeItemInfoLight = -13,
	UIBayaPOSNativeItemInfoDark = -14,
	
	UIBayaPOSNativeItemDisclosure = -15,
	
	UIBayaPOSNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BayaPOS instances of
